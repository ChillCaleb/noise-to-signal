...
def main() -> int:
    parser = argparse.ArgumentParser(description="Evaluate a batch of saved articles.")
    parser.add_argument("--dataset", help="CSV, JSON, or JSONL dataset with article text.")
    parser.add_argument("--artifact-dir", help="Directory of JSON article artifacts.")
    parser.add_argument("--outdir", default="artifacts/evaluation/batch")
    ...
    if not args.dataset and not args.artifact_dir:
        parser.error("Provide --dataset or --artifact-dir.")
